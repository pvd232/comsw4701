...
def main():
    initial = np.array([[2, 1, 0, 0], [0, 2, 2, 2], [0, 1, 2, 0], [1, 2, 1, 0]])

    child1 = np.array([[2, 1, 1, 0], [0, 2, 1, 2], [0, 1, 1, 0], [1, 2, 1, 0]])

    child2 = np.array([[2, 1, 0, 1], [0, 2, 1, 2], [0, 1, 2, 0], [1, 2, 1, 0]])

    child3 = np.array([[2, 1, 0, 0], [0, 2, 1, 2], [0, 1, 1, 1], [1, 2, 1, 0]])

    grandchild1 = np.array([[2, 2, 2, 0], [0, 2, 1, 2], [0, 1, 1, 1], [1, 2, 1, 0]])
    ...
    grandchild2 = np.array([[2, 1, 0, 0], [0, 2, 1, 2], [0, 1, 2, 2], [1, 2, 2, 2]])
    ...
    backprop(node5, -6)
    if node5.value == 6 and node3.value == -5 and root.value == 6:
