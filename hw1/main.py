...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        choices=range(1, 4),
        help="The world that we are testing on",
    )
    parser.add_argument(
        "-e",
        type=int,
        choices=range(1, 5),
        default=0,
        help="A* and local search heuristic options (1,3 for Manhattan; 2,4 for Euclidean)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        choices=range(1, 3),
        default=0,
        help="Animation options (1 for expanded nodes, 2 for path)",
    )
